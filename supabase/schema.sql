...
revoke all on public.nexo_state,public.nexo_messages,public.nexo_chat_usage from anon,authenticated;
...
revoke all on function public.nexo_read(jsonb),public.nexo_save(integer,jsonb),public.nexo_remember(text,text),public.nexo_chat_allow() from public,anon;
grant execute on function public.nexo_read(jsonb),public.nexo_save(integer,jsonb),public.nexo_remember(text,text),public.nexo_chat_allow() to authenticated;
commit;
